...
# --- 2. CSS & STYLING (v12.0 - MOBILE ROW FIX) ---
st.markdown(f"""
<style>
    ...
    /* 3. MODAL / DIALOG STYLING (BLACK INPUTS WITH WHITE BORDER) */
    div[role="dialog"] {{
    ...
    /* Στοχεύουμε το Wrapper του Input για να βάλουμε το πλαίσιο γύρω από ΟΛΑ (κείμενο + ματάκι) */
    ...
    .drawer-brand img {{ 
        width: 70px; height: 70px; border-radius: 50%; object-fit: cover; border: 2px solid #333; margin-bottom: 15px; 
    }}
    ...
    /* ========================================= */
    /* MOBILE FIXES (v12.0) - FORCED ROW LAYOUT  */
    /* ========================================= */
    @media only screen and (max-width: 768px) {{
        
        /* 1. ΑΝΑΓΚΑΣΤΙΚΗ ΟΡΙΖΟΝΤΙΑ ΔΙΑΤΑΞΗ (FLEX ROW) */
        /* Αυτό διορθώνει το πρόβλημα που το Sign In πέφτει από κάτω */
        ...
        /* Κολώνα 2: Spacer (Μέση) - Να πιάνει τον χώρο */
        [data-testid="stHorizontalBlock"]:nth-of-type(1) [data-testid="column"]:nth-of-type(2) {{
            width: auto !important;
            flex: 1 1 auto !important;
        }}

        /* Κολώνα 3: Sign In (Δεξιά) - Χωρίς απόλυτη θέση πια */
