...
def guess_category(text):
    ...
    # Πολεοδομία & Δόμηση (Προστέθηκαν: κτηματολόγιο, δασικά, αρχιτεκτον, design)
    ...
    # Ενέργεια & Περιβάλλον (Προστέθηκαν: απόβλητα, κυκλική, κλιματικ)
    ...
    # Φορολογικά & Ασφαλιστικά (Προστέθηκαν: τσμεδε, εφκα, επιδοτηση)
    ...
    # Δημόσια Έργα & ΕΣΠΑ (Προστέθηκαν: πεδμεδε, διακήρυξη, μειοδοτικ, ηλεία)
    ...
    # ΝΕΑ ΚΑΤΗΓΟΡΙΑ: Θεσμικά ΤΕΕ & Επαγγελματικά
    elif any(x in text for x in ['τεε', 'μηχανικ', 'επιμελητήριο', 'εκλογές', 'πειθαρχικ', 'σεμινάρι', 'ημερίδα']):
